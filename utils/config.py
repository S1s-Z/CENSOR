...
def config():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The tensorboard directory",
    )
    # Other parameters
    parser.add_argument(
    ...
    parser.add_argument('--ua_threshold', default=0.01, type=float, help="ua_threshold.")
    parser.add_argument('--coteaching_prob', default=0.3, type=float, help="coteaching_prob.")
